...
router.get('/op1',(req,res)=>{
    ...
    console.log(valor1, valor2, resultado, `Resulto por proceso ${process.pid} - worker: ${cluster.worker.id}`)
...
router.get('/op2',(req,res)=>{
    ...
    console.log(contador, resultado, `Resulto por proceso ${process.pid} - worker: ${cluster.worker.id}`)
    console.timeEnd("Demora operación:")
